...
class Weather:
    ...
    def main(self):
        ...
        if option not in ['-e', '-a', '-c']:
            print("The option should be (-e), (-a) or (-c).")
    ...
    def option_e(year,path,list_of_files):
        ...
        files = [file for file in list_of_files if year in file]
    ...
    def option_a(year,path,list_of_files):
            ...
            files = [file for file in list_of_files if year in file and month in file]
